...
(function (factory) {
	...
	var methods = {
		...
		show: function(e)
		{
			...
			// position scrolling
			var selected = list.find('.selectpickered');
	...
	function _render(self)
	{
		...
		if (settings.useSelect) {
			list = $('<select />', { 'class': 'selectpicker' });
		...
		if (settings.useSelect) {
			...
			list.on('mousedown touchstart', 'li', function(e) {
				...
				list.find('li').removeClass('selectpickered');
				$(this).addClass('selectpickered');
	...
	function _setSelected(self, list)
	{
		...
		if (selected) {
			...
			selected.addClass('selectpickered');
		}
	}
		...
		switch (e.keyCode) {
			...
			case 38: // up
				...
				if (!selected.length) {
					...
					selected.removeClass('selectpickered');
					selected.prev().addClass('selectpickered');
			...
			case 40: // down
				selected = list.find('.selectpickered');
				...
				if (selected.length === 0) {
					...
					selected.removeClass('selectpickered');
					selected.next().addClass('selectpickered');
	...
	*/
	...
	function _selectValue(self)
	{
		...
		var cursor = list.find('.selectpickered');
